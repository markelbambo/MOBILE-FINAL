...
$(document).on('click', '.manufacDevice', function(evt) {
	evt.preventDefault();
	deviceSideBar(this);
});
$(document).on('click', '.OSTypeDevice', function(evt) {
	evt.preventDefault();
	deviceSideBar(this);
});
$(document).on('click', '.prodFamilyDevice', function(evt) {
	evt.preventDefault();
	deviceSideBar(this);
});
$(document).on('click', '.modelDevice', function(evt) {
	evt.preventDefault();
    deviceSideBar(this);
});
...
$(document).on('click', '.connectGeneric', function(evt) {
	evt.preventDefault();
    connectivitySideBarScripts(this);
});
...
$(document).on('click', '#connectivitySubL1', function(evt) {
	evt.preventDefault();
	if(globalInfoType == "JSON"){
   		var devices = getDevicesNodeJSON();
    }else{
...
$(document).on('click', '#connectivitySubL2', function(evt) {
	evt.preventDefault();
	if(globalInfoType == "JSON"){
    	var devices = getDevicesNodeJSON();
    }else{
...
$(document).on('taphold','.devicePaletteTr', function() {
...
$(document).on('taphold','.testToolPaletteTr', function() {
...
$(document).on('taphold','.connPaletteTr', function() {
...
$(document).on('taphold',"#connectivityAny", function() {
